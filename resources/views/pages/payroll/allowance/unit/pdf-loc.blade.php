...
@section('title')
<x-status.allowance.type-unit :allowanceunit="$allowanceUnit" /> {{ $location->name }}   {{$allowanceUnit->unit->name}} {{$allowanceUnit->month}} {{$allowanceUnit->year}}
@endsection
@section('content')
               ...
               <thead>
                  <tr>
                     <td colspan="3" class="border-none text-uppercase">
                        <b>PT {{$allowanceUnit->unit->name}}  {{$location->name}}</b> <br>
            ...
            @if ($allowanceUnit->type == 2)
               <table >
                  ...
                  <tbody>
                     ...
                     <tr>
                        <td colspan="6" class="td-sm text-end">Total</td>
                        ...
                        <td class="td-sm text-end">{{formatRupiahB($allowances->sum('pokok') + $allowances->sum('tunj_jabatan') + $allowances->sum('tunj_ops') + $allowances->sum('tunj_kinerja') + $allowances->sum('tunj_fungsional') )}}</td>
