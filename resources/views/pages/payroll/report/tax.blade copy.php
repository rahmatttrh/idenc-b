...
<div class="page-inner">
   <nav aria-label="breadcrumb ">
      <ol class="breadcrumb  ">
         ...
         <li class="breadcrumb-item active" aria-current="page">Report Pajak </li>
      </ol>
   </nav>
      ...
      <div class="card-body p-0">
         ...
         {{-- <div class="table-responsive" style=""> --}}
            <table  >
               <thead>
                  <tr>
                     <td>PT {{ $unitTransaction->unit->name }}</td>
                  </tr>
                  <tr>
                     <td>List Daftar Karyawan</td>
                  </tr>
                  <tr>
                     <td>Bulan : {{ $unitTransaction->month }}</td>
                ...
                <table>
                  <thead>
                        <tr>
                           ...
                           <th>Lain-lain</th>
                           <th>Kompensasi</th>
                           <th>Tunj. Hari Raya</th>
                           <th>Pesangon/Uang</th>
                           <th>Perdin</th>
                           <th>Uang Duka/Tunj. Kelahiran</th>
                           <th>Bonus</th>
                        </tr>
                  </thead>
                  <tbody>
                        <!-- Contoh 10 baris kosong -->
                        <?php for($i=1; $i<=10; $i++): ?>
                        <tr>
                           <td><?= $i ?></td>
                           <td></td>
