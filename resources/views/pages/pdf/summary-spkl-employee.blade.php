            ...
            {{-- <div class="table-responsive"> --}}
               ...
               <table>
                  <tbody>
                     ...
                     <tr>
                        <td class="px-1 py-1" style="font-size: 10px">NIK</td>
                        <th colspan="17" class="px-1 py-1" style="font-size: 10px">{{$employee->nik}}</th>
                     </tr>
                     <tr>
                        <td class="px-1 py-1" style="font-size: 10px">Nama</td>
                        <th colspan="17" class="px-1 py-1" style="font-size: 10px">{{$employee->biodata->fullName()}} </th>
                     </tr>
                     {{-- <tr>
