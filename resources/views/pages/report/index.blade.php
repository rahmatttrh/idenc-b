         ...
         <table class="pb-2 table-bordered table table-sm">
            ...
            <tbody>
               ...
               <tr>  
                  <td class="text-center">4</td>
                  <td>Report Pajak</td>
                  <td>Laporan Rekap Pajak</td>
                  <td>
                      <a data-target="#modal-report-tax" data-toggle="modal" href="#"> Get Report </a> 
                     {{-- <a data-target="#modal-report-bpjs-tk" data-toggle="modal" href="#"> BPJS TK </a> --}}
                  </td>
               </tr>
               @endif
...
<div class="modal fade" id="modal-report-tax" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
   <div class="modal-dialog modal-sm" role="document">
      <div class="modal-content">
         <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Report Pajak<br>
         ...
         <form action="{{route('report.tax')}}" method="POST" enctype="multipart/form-data" target="_blank">
            <div class="modal-body">
