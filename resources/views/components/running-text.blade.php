...
{{-- <div class="shadow-lg"> --}}
   <marquee scrollamount="5" style="background-color: #e0dcdc" class="px-4 shadow-lg mb-3 rounded  py-2  " ><i class="fa fa-bell"></i> <a href="http://ticketing.enc.co.id/" target="_blank">Klik disini untuk melaporkan kendala seputar IT</a>  &nbsp;  &nbsp;  &nbsp; 
