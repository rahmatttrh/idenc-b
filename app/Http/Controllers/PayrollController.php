...
class PayrollController extends Controller
{
   ...
   public function calibrate($unit){
      ...
      //    ]);
      // }
      $employees = Employee::where('status', 1)->where('unit_id', $unit->id)->get();
      // dd($employees);
      ...
      foreach($employees as $employee){
         ...
         $reductions = Reduction::where('unit_id', $employee->unit_id)->where('name', 'JP')->get();
